...
path_ns_maps = r"../../data/ns-maps(bmode)/" #The no-signal maps
path_ws_maps_noise = r"../../data/ws-maps/noise(bmode)/" #The noise part of the with-signal maps

M = 400 #number of maps to be made.
...
def main():
    ...
    for i in range(start, start+M):
        m = generate_gaussian(bmode=True)
